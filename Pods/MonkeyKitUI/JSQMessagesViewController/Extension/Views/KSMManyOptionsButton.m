...
// private copy of center image
@property (strong, nonatomic) UIImage *privateCenterButtonImage;

// private copy of center string
@property (strong, nonatomic) NSString *privateCenterString;
...
- (instancetype)initWithFrame:(CGRect)frame
            centerButtonImage:(UIImage *)centerButtonImage
            centerButtonLabel:(NSString *)centerButtonLabel
              leftButtonImage:(UIImage *)leftButtonImage
             rightButtonImage:(UIImage *)rightButtonImage
               topButtonImage:(UIImage *)topButtonImage
         andBottomButtonImage:(UIImage *)bottomButtonimage
